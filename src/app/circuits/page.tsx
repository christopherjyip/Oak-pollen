...
import { CIRCUIT_IDS } from "@/lib/types";
...
export default function CircuitsPage() {
  ...
  const bodyCircuits = status.circuits.filter(
    (c) => c.id === CIRCUIT_IDS.POOL || c.id === CIRCUIT_IDS.SPA
  );
          ...
          {bodyCircuits.map((circuit) => (
            ...
            >
              <div>
                ...
                <p className="text-xs text-gray-500">ID: {circuit.id}</p>
              </div>
              <button
